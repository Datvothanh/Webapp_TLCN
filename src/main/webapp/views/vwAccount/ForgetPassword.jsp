...
<head>
    <title>Title</title>
    <style><%@include file="/css/forgetPassword.css"%></style>
    ...
    <div class="col-md-6 offset-md-3">
      <div class="card my-5">
        <form class="card-body cardbody-color p-lg-5" method="post">
          ...
          <div class="mb-3">
            <input type="password" class="form-control" id="ConfirmPassword" name="" placeholder="Xác nhận mật khẩu">
          </div>
          <div class="text-center"><button type="submit" class="btn btn-color px-5 mb-5 w-100">Xác nhận</button></div>
        </form>
      </div>
